...
<div><table><tr valign="top">
					...
					<td style="padding-left:10px" class="lien">
					   ...
					   <td style="padding-left:10px" class="lien">
							<a href="Modifiercalendrier.action" title="Modifier Calendrier">
...
<iframe src="https://www.google.com/calendar/embed?src=<c:out value="${calendrier.id}"/>&ctz=Europe/Paris" style="border: 0" width="600" height="400" frameborder="0" scrolling="no"></iframe>
</c:if>
<c:if test="${calendrier.class!='class fr.rendezvous.javabeans.Calendrier'}">
<div><blink>Vous avez pas encore creer de calendrier</blink></div>
</c:if>
</c:if>