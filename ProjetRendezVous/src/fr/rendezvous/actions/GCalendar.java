...
public class GCalendar{
	...
	public String execute(){
		// Create the calendar
				...
				calendar.setTitle(new PlainTextConstruct("titre27"));
				calendar.setSummary(new PlainTextConstruct("bgdescription"));
				...
				//id = returnedCalendar.getId().substring(55,81);
				for (int i = 0; i < returnedCalendar.getId().length(); i++) {
					if(returnedCalendar.getId().charAt(i)=='%')
						id = returnedCalendar.getId().substring(55,i);	
				}
