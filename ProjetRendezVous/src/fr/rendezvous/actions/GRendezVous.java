...
public class GRendezVous {
	...
	public CalendarEventEntry creerRdv(String titre,String adresse,String heureDeb,String heureFin,String mail, String mdp, String idcal) throws IOException, ServiceException{
		 myService = new CalendarService("exampleCo-exampleApp-1.0");
		 myService.setUserCredentials(mail, mdp);
		postURL = new URL("http://www.google.com/calendar/feeds/"+idcal+"/private/full");
...
*/
		...
		myEvent.setContent(new PlainTextConstruct(adresse));
		//String d="2013-04-18T19:00:00-08:00";String f="2013-04-18T20:00:00-08:00";
		DateTime startTime = DateTime.parseDateTime(heureDeb);
		//Create DateTime events and create a When object to hold them, then add
		//the When event to the event
		
		DateTime endTime = DateTime.parseDateTime(heureFin);
		When eventTimes = new When();
		eventTimes.setStartTime(startTime);
		eventTimes.setEndTime(endTime);
